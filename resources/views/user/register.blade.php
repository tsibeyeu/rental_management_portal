                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="{{route('user.Register')}}" method="post">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" name="second_name" id="inputLastName" type="text" placeholder="Enter your last name"  required/>
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="phone_number" id="inputEmail" type="tel" placeholder="enter phone number" />
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="{{route('user.showLogin')}}">Have an account? Go to login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
